    ...
    <>
      ...
      {!isOpen && (
        <button onClick={() => setIsOpen(true)} aria-label="Open chat"
          className="fixed z-50 flex items-center justify-center rounded-full shadow-lg transition-transform active:scale-95 bottom-[calc(80px+env(safe-area-inset-bottom,0px))] md:bottom-2 md:right-6"
